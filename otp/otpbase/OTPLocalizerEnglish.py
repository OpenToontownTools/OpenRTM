...
OpenChatWarning = 'You don\'t have any "True Friends" yet!\n\nTo become True Friends with somebody, click on them, and select "True Friends" from the detail panel.\n\nSpeedChat Plus can also be enabled. SpeedChat Plus is a form of type chat that allows users to communicate by using the Disney SpeedChat Plus dictionary.\n\nTo activate this feature or to learn more about it, exit Toontown and then click on "Preferences" under Member Services on the Toontown web page.\n\nOf course, you can always talk to anybody with SpeedChat.'
...
NoSecretChatWarning = 'To chat with a friend, the True Friends feature must first be enabled.  Kids, have your parent log in with their Parent Password to learn about True Friends.'
RestrictedSecretChatWarning = 'To get or enter a True Friend Code, you must enter the Parent Password. You can disable this prompt by changing your True Friends options.'
...
NoSecretChatAtAll = 'To use Open Chat with True Friends, you must first enable this feature. Open Chat with True Friends allows one member to chat with another member only by means of a True Friend Code that must be communicated outside of the game.\n\nTo activate this feature or to learn more about it, exit Toontown and then click on "Preferences" under Member Services on the Toontown web site.'
...
ChangeSecretFriendsOptionsWarning = '\nPlease enter the Parent Password to change your True Friends options.'
...
Please choose one of Toontown's True Friends options:
      ...
      \1shadow\1Restricted True Friends\2 - Requires the Parent Password to make
      each new True Friend.

      \1shadow\1Unrestricted True Friends\2 - Once enabled with the Parent Password,
...
1. Sally's parent and Mike's parent each enable the Open Chat with True Friends feature by entering their respective Parent Passwords either (a) in the Account Options areas within the Service, or (b) when prompted within the game by a Parental Controls pop-up.
...
FriendSecretNeedsParentLoginWarning = """To get or enter a True Friend Code, your parent must login.  You can disable this prompt by changing your True Friends options."""
FriendSecretNeedsPasswordWarning = """To get or enter a True Friend Code, you must enter the Parent Password.  You can disable this prompt by changing your True Friends options."""
