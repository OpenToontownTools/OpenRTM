...
# grouping messages
groupInviteMessage = "%s would like you to join their group"
...
# TODO: REMOVE - Added by SG to get things working
VampireMickeyChatter = (
    [ # Greetings specific to Mickey
        "Welcome to "+lToontownCentral+".",
        "Hi, my name is Vampire "+Mickey+". What's yours?",
    ],
)
VampireMickey = "Vampire Mickey"
...
# TeaserPanel.py
TeaserTop = "  Sorry, but you can't do that with a Free account."
TeaserBottom = "Subscribe now and enjoy these great features:"
TeaserOtherHoods = "Fully explore all 6 unique neighborhoods!"
TeaserTypeAName = "Type in your favorite name for your Toon!"
TeaserSixToons = "Create up to 6 Toons on one account!"
TeaserOtherGags = "Collect 7 skill levels in 6 different gag tracks!"
...
TeaserSecretChat = "Use the Open Chat with True Friends function to chat\n  openly with your real-life friends!"
TeaserCardsAndPosters = "Receive a welcome pack and bi-monthly newsletters\n  with posters and other cool stuff!"
TeaserHolidays = "Participate in exciting special events and holiday\n  celebrations!"
TeaserQuests = "Complete hundreds of ToonTasks to help save\n  Toontown!"
TeaserEmotions = "Purchase phrases and emotions to make\n  your Toon more expressive!"
TeaserMinigames = "Play all 16 minigame varieties!"
TeaserKarting = "Race against other Toons on the city and country\n  tracks, and foil your opponents with gags."
TeaserKartingAccessories = "Individualize your kart with cool, custom accessories."
TeaserGardening = "Plant flowers, statues, and gag trees to beautify\n  your estate."
TeaserRental = "Rent fun party items for your estate!"
TeaserBigger = "Purchase bigger and better Toon items!"
TeaserTricks = "Train your Doodle to perform tricks and help in battle!"
TeaserSpecies = "Create and play Monkey, Horse, and Bear Toons!"
TeaserFishing = "Collect all fish species!"
TeaserGolf = "Play on wacky golf courses!"
...
# EventsPage.py
PartyDateFormat = "%s %d, %.4d" # Dec 8, 2008
...
EventsPageHostingTabActivityListTitle = "Activites"
...
EventsPageInvitedTabActivityListTitle = "Activites"
...
PartyPlannerConfirmationValidationErrorText = "Sorry, there seems to be a\nproblem with that party.\nPlease go back and try again."
...
PartyPlannerInvitationThemeWhatSentence = "You are invited to my %s %s party! %s!"
PartyPlannerInvitationThemeWhatSentenceNoFriends = "I am hosting a %s %s party! %s!"
PartyPlannerInvitationThemeWhatActivitiesBeginning = "It will have "
PartyPlannerInvitationWhoseSentence = "%s's %s Party"
...
PartyOverWarning = "The party has ended, you don't have to go home, but you can't stay here."
...
PartyActivityNameDict = {
    ...
    5 : {
        ...
        "editor" : "Tug-o-war",
        "description" : "Up to 4 on 4 toon tugging crazyness!"
    },
    6 : {
...
PartyPlannerNpcMinCost = "It costs a minmum of %d jellybeans to plan a party."
...
PartyGatePartiesListTitle = "Hosts (toons, activities)"
...
PartyCatchActivityInstructions = "Catch as many %(fruit)s as you can. Try not to 'catch' any %(badThing)s!"
...
PartyTugOfWarTeamFull = "Sorry. This team is already full."
...
PartyTugOfWarTitle = "Party Tug-O-War"
...
# PlayGame.py
HeadingToHood = "Heading %s %s..." # hood name
...
HeadingToStreet = "Heading %s %s..." # Street name
...
QuestScriptTutorialBlocker_7 = "It's called the Chat button. You need to turn on Speedchat Plus in Member Preferences on the Toontown Web site to use it."
...
TipDict = {
  ...
  TIP_MINIGAME : (
    ...
    "In the Tug-O-War you are awarded more jellybeans if you play against a tougher Cog.",
...
BoardingInviteeInKickOutList = '%s had been kicked out by your leader. Only the leader can invite kicked out members again.'
BoardingAlreadyInGroup = 'You cannot accept this invitation because you are part of another Boarding Group.'
BoardingKickOutConfirm = 'Are you sure you want to kick out %s.'
BoardingPendingInvite = 'You need to deal with the\n pending invitation first.'
BoardingCannotLeaveZone = 'You cannot leave this zone because you are part of a Boarding Group.'
BoardingGo = 'GO'
And = 'and'
