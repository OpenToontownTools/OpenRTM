...
NametagColors = {
    ...
    CCSuit: (
        ...
        (VBase4(1.0, 1.0, 1.0, 1.0), VBase4(0.2, 0.2, 0.2, 0.6)),  # Down
        (VBase4(0.5, 0.5, 0.5, 1.0), VBase4(1.0, 1.0, 1.0, 1.0)),  # Rollover
    ...
    CCToonBuilding: (
        ...
        (VBase4(0.2, 0.6, 0.9, 1.0), VBase4(0.2, 0.2, 0.2, 0.6)),  # Down
        (VBase4(0.2, 0.6, 0.9, 1.0), VBase4(1.0, 1.0, 1.0, 1.0)),  # Rollover
    ...
    CCSpeedChat: (
        (VBase4(0.0, 0.6, 0.2, 1.0), VBase4(1.0, 1.0, 1.0, 0.5)),  # Normal
        (VBase4(0.0, 0.6, 0.2, 1.0), VBase4(0.2, 0.2, 0.2, 0.6)),  # Down
        (VBase4(0.0, 1.0, 0.5, 1.0), VBase4(1.0, 1.0, 1.0, 1.0)),  # Rollover
        (VBase4(0.1, 0.4, 0.2, 1.0), VBase4(0.8, 0.8, 0.8, 0.5))   # Disabled
    ),
    CCFreeChat: (
