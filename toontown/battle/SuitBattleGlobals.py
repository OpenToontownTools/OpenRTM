...
def getSuitAttack(suitName, suitLevel, attackNum=-1):
    ...
    name = attack[0]
    adict['name'] = name
    adict['id'] = SuitAttacks.index(name)
    adict['animName'] = SuitAttacks[name][0]
...
AUDIT = SuitAttacks.index('Audit')
BITE = SuitAttacks.index('Bite')
BOUNCE_CHECK = SuitAttacks.index('BounceCheck')
BRAIN_STORM = SuitAttacks.index('BrainStorm')
BUZZ_WORD = SuitAttacks.index('BuzzWord')
CALCULATE = SuitAttacks.index('Calculate')
CANNED = SuitAttacks.index('Canned')
CHOMP = SuitAttacks.index('Chomp')
CIGAR_SMOKE = SuitAttacks.index('CigarSmoke')
CLIPON_TIE = SuitAttacks.index('ClipOnTie')
CRUNCH = SuitAttacks.index('Crunch')
DEMOTION = SuitAttacks.index('Demotion')
DOWNSIZE = SuitAttacks.index('Downsize')
DOUBLE_TALK = SuitAttacks.index('DoubleTalk')
EVICTION_NOTICE = SuitAttacks.index('EvictionNotice')
EVIL_EYE = SuitAttacks.index('EvilEye')
FILIBUSTER = SuitAttacks.index('Filibuster')
FILL_WITH_LEAD = SuitAttacks.index('FillWithLead')
FINGER_WAG = SuitAttacks.index('FingerWag')
FIRED = SuitAttacks.index('Fired')
FIVE_O_CLOCK_SHADOW = SuitAttacks.index('FiveOClockShadow')
FLOOD_THE_MARKET = SuitAttacks.index('FloodTheMarket')
FOUNTAIN_PEN = SuitAttacks.index('FountainPen')
FREEZE_ASSETS = SuitAttacks.index('FreezeAssets')
GAVEL = SuitAttacks.index('Gavel')
GLOWER_POWER = SuitAttacks.index('GlowerPower')
GUILT_TRIP = SuitAttacks.index('GuiltTrip')
HALF_WINDSOR = SuitAttacks.index('HalfWindsor')
HANG_UP = SuitAttacks.index('HangUp')
HEAD_SHRINK = SuitAttacks.index('HeadShrink')
HOT_AIR = SuitAttacks.index('HotAir')
JARGON = SuitAttacks.index('Jargon')
LEGALESE = SuitAttacks.index('Legalese')
LIQUIDATE = SuitAttacks.index('Liquidate')
MARKET_CRASH = SuitAttacks.index('MarketCrash')
MUMBO_JUMBO = SuitAttacks.index('MumboJumbo')
PARADIGM_SHIFT = SuitAttacks.index('ParadigmShift')
PECKING_ORDER = SuitAttacks.index('PeckingOrder')
PICK_POCKET = SuitAttacks.index('PickPocket')
PINK_SLIP = SuitAttacks.index('PinkSlip')
PLAY_HARDBALL = SuitAttacks.index('PlayHardball')
POUND_KEY = SuitAttacks.index('PoundKey')
POWER_TIE = SuitAttacks.index('PowerTie')
POWER_TRIP = SuitAttacks.index('PowerTrip')
QUAKE = SuitAttacks.index('Quake')
RAZZLE_DAZZLE = SuitAttacks.index('RazzleDazzle')
RED_TAPE = SuitAttacks.index('RedTape')
RE_ORG = SuitAttacks.index('ReOrg')
RESTRAINING_ORDER = SuitAttacks.index('RestrainingOrder')
ROLODEX = SuitAttacks.index('Rolodex')
RUBBER_STAMP = SuitAttacks.index('RubberStamp')
RUB_OUT = SuitAttacks.index('RubOut')
SACKED = SuitAttacks.index('Sacked')
SANDTRAP = SuitAttacks.index('SandTrap')
SCHMOOZE = SuitAttacks.index('Schmooze')
SHAKE = SuitAttacks.index('Shake')
SHRED = SuitAttacks.index('Shred')
SONG_AND_DANCE = SuitAttacks.index('SongAndDance')
SPIN = SuitAttacks.index('Spin')
SYNERGY = SuitAttacks.index('Synergy')
TABULATE = SuitAttacks.index('Tabulate')
TEE_OFF = SuitAttacks.index('TeeOff')
THROW_BOOK = SuitAttacks.index('ThrowBook')
TREMOR = SuitAttacks.index('Tremor')
WATERCOOLER = SuitAttacks.index('Watercooler')
WITHDRAWAL = SuitAttacks.index('Withdrawal')
WRITE_OFF = SuitAttacks.index('WriteOff')
