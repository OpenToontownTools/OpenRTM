...
AUDIT = SuitAttacks['Audit']
BITE = SuitAttacks['Bite']
BOUNCE_CHECK = SuitAttacks['BounceCheck']
BRAIN_STORM = SuitAttacks['BrainStorm']
BUZZ_WORD = SuitAttacks['BuzzWord']
CALCULATE = SuitAttacks['Calculate']
CANNED = SuitAttacks['Canned']
CHOMP = SuitAttacks['Chomp']
CIGAR_SMOKE = SuitAttacks['CigarSmoke']
CLIPON_TIE = SuitAttacks['ClipOnTie']
CRUNCH = SuitAttacks['Crunch']
DEMOTION = SuitAttacks['Demotion']
DOWNSIZE = SuitAttacks['Downsize']
DOUBLE_TALK = SuitAttacks['DoubleTalk']
EVICTION_NOTICE = SuitAttacks['EvictionNotice']
EVIL_EYE = SuitAttacks['EvilEye']
FILIBUSTER = SuitAttacks['Filibuster']
FILL_WITH_LEAD = SuitAttacks['FillWithLead']
FINGER_WAG = SuitAttacks['FingerWag']
FIRED = SuitAttacks['Fired']
FIVE_O_CLOCK_SHADOW = SuitAttacks['FiveOClockShadow']
FLOOD_THE_MARKET = SuitAttacks['FloodTheMarket']
FOUNTAIN_PEN = SuitAttacks['FountainPen']
FREEZE_ASSETS = SuitAttacks['FreezeAssets']
GAVEL = SuitAttacks['Gavel']
GLOWER_POWER = SuitAttacks['GlowerPower']
GUILT_TRIP = SuitAttacks['GuiltTrip']
HALF_WINDSOR = SuitAttacks['HalfWindsor']
HANG_UP = SuitAttacks['HangUp']
HEAD_SHRINK = SuitAttacks['HeadShrink']
HOT_AIR = SuitAttacks['HotAir']
JARGON = SuitAttacks['Jargon']
LEGALESE = SuitAttacks['Legalese']
LIQUIDATE = SuitAttacks['Liquidate']
MARKET_CRASH = SuitAttacks['MarketCrash']
MUMBO_JUMBO = SuitAttacks['MumboJumbo']
PARADIGM_SHIFT = SuitAttacks['ParadigmShift']
PECKING_ORDER = SuitAttacks['PeckingOrder']
PICK_POCKET = SuitAttacks['PickPocket']
PINK_SLIP = SuitAttacks['PinkSlip']
PLAY_HARDBALL = SuitAttacks['PlayHardball']
POUND_KEY = SuitAttacks['PoundKey']
POWER_TIE = SuitAttacks['PowerTie']
POWER_TRIP = SuitAttacks['PowerTrip']
QUAKE = SuitAttacks['Quake']
RAZZLE_DAZZLE = SuitAttacks['RazzleDazzle']
RED_TAPE = SuitAttacks['RedTape']
RE_ORG = SuitAttacks['ReOrg']
RESTRAINING_ORDER = SuitAttacks['RestrainingOrder']
ROLODEX = SuitAttacks['Rolodex']
RUBBER_STAMP = SuitAttacks['RubberStamp']
RUB_OUT = SuitAttacks['RubOut']
SACKED = SuitAttacks['Sacked']
SANDTRAP = SuitAttacks['SandTrap']
SCHMOOZE = SuitAttacks['Schmooze']
SHAKE = SuitAttacks['Shake']
SHRED = SuitAttacks['Shred']
SONG_AND_DANCE = SuitAttacks['SongAndDance']
SPIN = SuitAttacks['Spin']
SYNERGY = SuitAttacks['Synergy']
TABULATE = SuitAttacks['Tabulate']
TEE_OFF = SuitAttacks['TeeOff']
THROW_BOOK = SuitAttacks['ThrowBook']
TREMOR = SuitAttacks['Tremor']
WATERCOOLER = SuitAttacks['Watercooler']
WITHDRAWAL = SuitAttacks['Withdrawal']
WRITE_OFF = SuitAttacks['WriteOff']
