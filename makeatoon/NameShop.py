...
class NameShop(StateData.StateData):
    ...
    def makeScrollList(self, gui, ipos, mcolor, nitems,
        ...
        ds = DirectScrolledList(
            ...
            incButton_image = (gui.find("**/triangleButtonUp"),
                               gui.find("**/triangleButtonDwn"),
                               gui.find("**/triangleButtonRllvr"),
                               gui.find("**/triangleButtonUp"),
                               ),
            incButton_relief = None,
            incButton_scale = (1.2,1.2,-1.2),
            incButton_pos = (0,0,-0.545),
            ...
            decButton_image = (gui.find("**/triangleButtonUp"),
                               gui.find("**/triangleButtonDwn"),
                               gui.find("**/triangleButtonRllvr"),
                               gui.find("**/triangleButtonUp"),
                               ),
    ...
    def load(self):
        ...
        if base.cr.productName in ['Terra-DMC','Terra-ES','T-Online']:
            # No type-a-name for Terra (Spain) and T-Online (German)
