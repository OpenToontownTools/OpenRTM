...
class DirectSession(DirectObject):
    ...
    def __init__(self):
        ...
        self.actionEvents = [
            ...
            ['RTMDIRECT-delete', self.removeAllSelected],
            ['RTMDIRECT-Undo', self.undo],
            ['RTMDIRECT-Redo', self.redo],
            ['RTMDIRECT-OOBE', self.oobe],
            ['RTMDIRECT-toggleWidgetVis', self.toggleWidgetVis],
            ['RTMDIRECT-toggleWireframe', base.toggleWireframe],
            ['RTMDIRECT-toggleVisAll', self.selected.toggleVisAll],
            ['RTMDIRECT-toggleTexture', base.toggleTexture],
            ['RTMDIRECT-upAncestry', self.upAncestry],
            ['RTMDIRECT-downAncestry', self.downAncestry],
            ['RTMDIRECT-toggleBackface', base.toggleBackface],
            ['RTMDIRECT-flash', self.flash],
            ['RTMDIRECT-toggleLigths', self.lights.toggle],
            ['RTMDIRECT-toggleCOALock', self.cameraControl.toggleCOALock],
            ['RTMDIRECT-setActiveParent', self.doSetActiveParent],
            ['RTMDIRECT-doWrtReparent', self.doWrtReparent],
            ['RTMDIRECT-doReparent', self.doReparent],
            ['RTMDIRECT-doSelect', self.doSelect],
            ]
